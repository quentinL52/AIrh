...
DOCUMENT_ID = "6827747f5f4f1692e6f20b50"
document_candidat = manager.fetch_document_by_id(DOCUMENT_ID)
cv = format_cv(document_candidat)

#############################################################
# offre d'emploi

from data.cache_api_offres import load_job_offer_from_api 
api = "https://quentinl52-data-api.hf.space/offre-emploi/" 
id_offre_emploi = "f5b16d74-4d9b-4ee2-b1ed-44e79b898bd8"
